...
Ссылка на проект: https://github.com/Ben4-front/RxJS-Frontend/
[![Build and Deploy](https://github.com/Ben4-front/RxJS-Frontend/actions/workflows/web.yml/badge.svg)](https://github.com/Ben4-front/RxJS-Frontend/actions/workflows/web.yml)
...
6. (со звездочкой, пункт не обязателен для выполнения) Серверная часть должна быть выложена на сервере. Вы можете использовать сервер Vercel (для 1 и 2 задачи, для 3 задачи серверная часть не требуется)
